...
const classes: Record<ButtonColors, Record<ButtonVariants, string>> = {
  primary: {
    ...
    outline:
      "hover:bg-blue-50 active:bg-blue-50 text-blue-500 border border-blue-500",
  ...
  secondary: {
    ...
    outline:
      "hover:bg-gray-100 active:bg-gray-50 text-gray-800 border border-gray-500",
  ...
  warning: {
    ...
    outline:
      "hover:bg-orange-50 active:bg-orange-50 text-orange-600 border border-orange-500",
    faded:
  ...
  danger: {
    ...
    outline:
      "hover:bg-red-50 active:bg-red-50 text-red-600 border border-red-500",
  ...
  success: {
    ...
    outline:
      "hover:bg-green-50 active:bg-green-50 text-green-600 border border-green-500",
