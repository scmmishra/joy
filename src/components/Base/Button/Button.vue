...
<template>
  <button
    class="inline-flex items-center justify-center gap-1.5 transition-colors duration-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
    :class="{
