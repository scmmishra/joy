...
const COLOR_OPTIONS: Record<UIColors, Record<UIVariants, string>> = {
  primary: {
    ...
    outline:
      "hover:bg-blue-50 active:bg-blue-50 text-blue-500 outline outline-blue-300",
  ...
  secondary: {
    ...
    outline:
      "hover:bg-gray-100 active:bg-gray-50 text-gray-800 outline outline-gray-200",
  ...
  warning: {
    ...
    outline:
      "hover:bg-orange-50 active:bg-orange-50 text-orange-600 outline outline-orange-300",
    faded:
  ...
  danger: {
    ...
    outline:
      "hover:bg-red-50 active:bg-red-50 text-red-600 outline outline-red-300",
  ...
  success: {
    ...
    outline:
      "hover:bg-green-50 active:bg-green-50 text-green-600 outline outline-green-300",
